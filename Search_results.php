...
<html>
  <head>
     ...
     <![endif]-->
      ...
      <title>Trip it! - Search results </title>
  </head>
        ...
        <div class="container white">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="thumbnail">
                        <img src="img/Ed.jpg" alt="place-image">
                        <div class="caption">
                            <h3>Place Name</h3>
                            <p>...</p>
                            <a href="Place_profile.php" class="readmoreSEARCH" >read more</a><br><br>
                            <p><a href="#" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Calendar</a> <a href="#" class="btn btn-default wish-listSEARCH" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> wish list</a></p>
